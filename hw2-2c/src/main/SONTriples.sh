...
hadoop jar hw2-2c-1.0-SNAPSHOT.jar cuhk.iems5709.SONTriplesDriver1 $num_mappers $num_reducers $total_size &&
hdfs dfs -cat output/hw2/2c-1/part-* | hdfs dfs -copyFromLocal - output/hw2/2c-1/merge &&
hadoop jar hw2-2c-1.0-SNAPSHOT.jar cuhk.iems5709.SONTriplesDriver2 $num_mappers $total_size &&
end_time=$(date "+%s") &&
